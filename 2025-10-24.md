...
Well I didn't pull out my hair. I'm in the process of migrating to the new schema scary thought, but have done it in a way, that is not destructive, and have taken db backup a `db dump` (the person who decided to call it a dump must have been having a laught) so should be safe if something goes wrong :fingers_crossed:


### What have I learned today?
I needed to make a google feedback form, to gather some user feedback on the application, and learned that google docs has appscripts which makes it so you can well run a script and make a form or whatever you want to make. So I used claude to help make my form questions, and then turn it into an app script that I pasted into google docs and in about 5 minutes maybe less. I had the form I needed with good questions, and sent out, meaning I could get back to the work I needed to be focused on.
